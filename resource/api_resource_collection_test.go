...
func TestAPIResourceCollection(t *testing.T) {
	res1 := resource.NewUnimplemented(generic.Named("name1"))
	res2 := resource.NewUnimplemented(generic.Named("name2"))
	...
	resources = map[resource.Name]resource.Resource{
		resource.NewName(
			...
			"",
		): resource.NewUnimplemented(generic.Named("")),
	}
	err = svc.ReplaceAll(resources)
...
func TestAPIRemoteNames(t *testing.T) {
	...
	res0 := resource.NewUnimplemented(generic.Named(name0))
	res1 := resource.NewUnimplemented(generic.Named(name1))
	res2 := resource.NewUnimplemented(generic.Named(name2))
	res3 := resource.NewUnimplemented(generic.Named(name3))
	res4 := resource.NewUnimplemented(generic.Named(name4))
	res5 := resource.NewUnimplemented(generic.Named(name5))
	res7 := resource.NewUnimplemented(generic.Named(name7))
	res8 := resource.NewUnimplemented(generic.Named(name8))
	res9 := resource.NewUnimplemented(generic.Named(name9))
	res10 := resource.NewUnimplemented(generic.Named(name10))
...
func TestAPIAddRemoveReplaceOne(t *testing.T) {
	...
	svc, err := resource.NewAPIResourceCollection(generic.API, map[resource.Name]resource.Resource{
		key1: resource.NewUnimplemented(generic.Named(str1)),
		key4: resource.NewUnimplemented(generic.Named(str4)),
	})
	test.That(t, err, test.ShouldBeNil)
	res, err := svc.Resource(name1)
	test.That(t, err, test.ShouldBeNil)
	test.That(t, res, test.ShouldResemble, resource.NewUnimplemented(generic.Named(str1)))
	...
	res, err = svc.Resource(name4)
	test.That(t, err, test.ShouldBeNil)
	test.That(t, res, test.ShouldResemble, resource.NewUnimplemented(generic.Named(str4)))
	res, err = svc.Resource(name4s)
	test.That(t, err, test.ShouldBeNil)
	test.That(t, res, test.ShouldResemble, resource.NewUnimplemented(generic.Named(str4)))

	test.That(t, svc.Add(key2, resource.NewUnimplemented(generic.Named(str2))), test.ShouldBeNil)
	res, err = svc.Resource(name2)
	test.That(t, err, test.ShouldBeNil)
	test.That(t, res, test.ShouldResemble, resource.NewUnimplemented(generic.Named(str2)))

	test.That(t, svc.Add(key3, resource.NewUnimplemented(generic.Named(str3))), test.ShouldBeNil)
	res, err = svc.Resource(name3)
	test.That(t, err, test.ShouldBeNil)
	test.That(t, res, test.ShouldResemble, resource.NewUnimplemented(generic.Named(str3)))

	test.That(t, svc.ReplaceOne(key2, resource.NewUnimplemented(generic.Named(strR))), test.ShouldBeNil)
	res, err = svc.Resource(name2)
	test.That(t, err, test.ShouldBeNil)
	test.That(t, res, test.ShouldResemble, resource.NewUnimplemented(generic.Named(strR)))

	test.That(t, svc.ReplaceOne(key4, resource.NewUnimplemented(generic.Named(strR))), test.ShouldBeNil)
	res, err = svc.Resource(name4)
	test.That(t, err, test.ShouldBeNil)
	test.That(t, res, test.ShouldResemble, resource.NewUnimplemented(generic.Named(strR)))
	res, err = svc.Resource(name4s)
	...
	test.That(t, svc.Add(key4d, resource.NewUnimplemented(generic.Named(str4))), test.ShouldBeNil)
